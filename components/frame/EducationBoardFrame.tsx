...
const EducationBoardFrame: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <div className={styles.desktopBg}>
      <div className={styles.desktopFrame}>
        ...
        {userModalOpen && (
          <div style={{
            ...
            <div style={{
              ...
              <h2 style={{marginBottom: 24, fontSize: 20, textAlign: "center"}}>教育委員会ユーザー情報</h2>
              ...
              <div style={{ marginBottom: 20 }}>
                <div style={{
                  ...
                  <div style={{
                    ...
                    alignItems: "center",
                    padding: "8px",
                    border: selectedIcon === "customImage" ? "2px solid #8b5cf6" : "1px solid #d1d5db",
                    borderRadius: "8px",
                    background: selectedIcon === "customImage" ? "#f3e8ff" : "#fff",
                    position: "relative",
                    cursor: "pointer",
                    ...
                    {uploadedImage ? (
                      <>
                        ...
                        <span style={{ 
                          ...
                          textAlign: "center", 
                          lineHeight: "1.2",
                          color: selectedIcon === "customImage" ? "#7c3aed" : "#6b7280"
                        }}>
                          カスタム
                        </span>
                  ...
                  {Object.entries(iconOptions).map(([key, { component: IconComponent, label }]) => (
                    <button
                      ...
                      style={{
                        ...
                        alignItems: "center",
                        padding: "8px",
                        border: selectedIcon === key ? "2px solid #8b5cf6" : "1px solid #d1d5db",
                        borderRadius: "8px",
                        background: selectedIcon === key ? "#f3e8ff" : "#fff",
                        cursor: "pointer",
                        transition: "all 0.2s ease",
                        fontSize: "10px",
                        color: selectedIcon === key ? "#7c3aed" : "#6b7280"
                      }}
                      onMouseEnter={(e) => {
                        if (selectedIcon !== key) {
              ...
              <div style={{marginBottom: 12, color: "#8b5cf6", fontWeight: "600"}}>教育委員会管理者</div>
              {userInfo ? (
                <>
                  <div style={{marginBottom: 12}}>メールアドレス：{userInfo.email}</div>
                  <div style={{marginBottom: 12}}>ユーザー名：{userInfo.name}</div>
                  <div style={{marginBottom: 12}}>管轄地域：{userInfo.school}</div>
                </>
              ) : (
                <div>読み込み中...</div>
              )}
            ...
            <div className={styles.sidebarLeft}>
              <div className={styles.sidebarContent}>
                ...
                <button
                  className={stylesBtn.sidebarBtn}
                  onClick={() => {
                    router.push("/many_maker/calendar");
                    setSidebarOpen(false);
                  }}
                >
                  カレンダー
                ...
                <button
                  className={stylesBtn.sidebarBtn}
                  onClick={() => {
                    router.push("/many_maker/notification");
                    setSidebarOpen(false);
                  }}
                >
                  通知送信
                ...
                <button
                  className={stylesBtn.sidebarBtn}
                  onClick={() => {
                    router.push("/many_maker/notification-history");
                    setSidebarOpen(false);
                  }}
                >
                  通知履歴
                ...
                <button
                  className={stylesBtn.sidebarBtn}
                  onClick={() => {
                    router.push("/many_maker/setting");
                    setSidebarOpen(false);
                  }}
                >
                  システム設定
        ...
        {/* フッター */}
        <div className={styles.footer}>© 2025 教育委員会管理システム</div>
      </div>
    </div>
  );
};

export default EducationBoardFrame;